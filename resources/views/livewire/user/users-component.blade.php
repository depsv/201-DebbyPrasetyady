            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    ...
                    <h1 class="flex justify-between items-center text-2xl font-medium text-gray-900 dark:text-white">
                        ...
                        <div>
                            <x-button wire:navigate href="/users/add" class="bg-blue-500 hover:bg-blue-700">
                                {{ __('Add New User') }}
                            </x-button>
                        </div>
                    </h1>
                                ...
                                @foreach ($users as $index => $user)
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2 text-center flex justify-center items-center">
                                            <x-button wire:navigate href="/users/edit/{{ $user->id }}" class="bg-orange-500 hover:bg-orange-700 mr-2">
                                                {{ __('Edit') }}
                                            </x-button>
